...
const $team1Caption= document.getElementById('team1')
...
const $team2Caption= document.getElementById('team2')
...
const $imgPoliceSelf = document.getElementById('imgpolice_self')
    ...
    (function (game) {
        game.GameView = (function () {
            ...
            GameView.prototype.setGameCaption = function (name, status) {
                ...
                <p class="navbar-text">
                    ${name}
                    <span class="label label-warning" id = "gameCaption">${utils.getStatusName(status)}</span>
                </p> 
                </div>
                `
